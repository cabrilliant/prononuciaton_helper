...
- Highlight Eligible Words: If enabled, all words that have a pronunciation available will be highlighted in dialogue with the specified color. Ignored if Always Shown pronunciation is enabled
